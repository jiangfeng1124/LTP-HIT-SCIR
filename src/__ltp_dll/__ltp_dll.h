...
LTP_DLL_API int IRLAS();		// Word segment and POS
...
LTP_DLL_API int WSD();			// Word sense disambiguation
LTP_DLL_API int GParser();		// Dependency parser (Graph-based Method)
LTP_DLL_API int Parser();		// Dependency parser (Ma Jinshan)
...
// Get WSD
LTP_DLL_API int	GetWSD(pair<const char *, const char *> &WSD_explain, int paragraphIdx, int sentenceIdx, int wordIdx);
LTP_DLL_API int	GetWSD(pair<const char *, const char *> &WSD_explain, int globalSentIdx, int wordIdx);
LTP_DLL_API int	GetWSD(pair<const char *, const char *> &WSD_explain, int globalWordIdx);
