...
LTPResource::LTPResource() : 
				m_irlasSeggerPtr(NULL), m_nerPtr(NULL),
				m_isLoadIrlasRes(false), m_isLoadSvmtaggerRes(false), m_isLoadNeRes(false), m_isLoadGParserRes(false),
				m_isLoadParserRes(false), m_isLoadWsdRes(false), m_isLoadSrlRes(false), m_isLoadCRFWSRes(false)
{
}
