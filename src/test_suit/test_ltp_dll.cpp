...
int test_main2()
{
	//return main2("D:\\Projects\\ltp-linux\\test_data\\test_gb.txt", "test_main2.xml");
...
{	
	...
	//cout << CreateDOMFromString("周华健2008新年倒计时演唱会12月31日在上海举行，成龙、火炬手金晶等嘉宾捧场。") << endl;
	...
	//copy(vecWord.begin(), vecWord.end(), ostream_iterator<const char *>(cerr, " ")); cerr << endl;
	//copy(vecPOS.begin(), vecPOS.end(), ostream_iterator<const char *>(cerr, " ")); cerr << endl;
	...
	cout << "test.txt" << endl;
	cout << main2("test.txt", "test0.xml") << endl;
